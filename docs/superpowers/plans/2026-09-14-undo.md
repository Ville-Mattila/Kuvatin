...
```bash
git add crates/kuvatin/src/gui/image_mode.rs crates/kuvatin/src/gui/image_mode/history.rs crates/kuvatin/src/gui/mod.rs crates/kuvatin/ui/app.slint
git commit -F - <<'MSG'
...
batch runs, like Clear and remove already are.
